                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    <select class="form-control  basic">
                                        ...
                                        <option value="{{$single_brand->id}}">{{$single_brand->name}}
                                        </option>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" placeholder="Categories" id="category-name" name="categoryname">
                    ...
                    <div class="table-responsive mt-4 mb-4">
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td id="categoryid" name="categoryid">{{$single_categories->id}}</td>
                                    <td><input type="text" id="row-1-age" class="form-control" name="row-1-age" value="{{$single_categories->name}}"></td>
                                    <td><input type="date" id="row-1-position" class="form-control" name="row-1-position" value="{{$single_created_at->created_at}}"></td>
                                    <td><select size="1" id="activestatus" class="form-control" name="activestatus">
                                            <option value="1" @if($single_categories->active == 1)selected="selected" @endif>
                                                Active
                                            </option>
                                            <option value="0" @if($single_categories->active == 0)selected="selected" @endif>
                                                Deactive
                                            </option>
